 ...
 */
 // contract oracles Chainlink 0x2b4dd2BC8A0736D2A356a3D9A4EbaB907c604dbD RINKEBY & transfer owners
  // contract oracles Chainlink  0x80732A1856F511f59E498Fc4626a731838753e0f number ID
...
contract VRFD20 is VRFConsumerBase, Owned {
     ...
     */
    function rollDice(uint256 userProvidedSeed, address roller) public  returns (bytes32 requestId) { // onlyOwner --> RIKS ATACK WARNING
    ...
    /**
     * @notice Get the current address contract Chainlinklink
     *
     * @return address
     */
    function address_contract() public view returns (address) {
        return address(this);
    }
